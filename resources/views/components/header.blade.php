    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link @if(request()->routeIs('news.categories')) active @endif" href="{{ route('news.categories') }}">Worldwide job</a></li>
                <li class="nav-item"><a class="nav-link @if(request()->routeIs('news.news')) active @endif" href="{{ route('news.news', mt_rand(6, 12)) }}">Job news</a></li>
